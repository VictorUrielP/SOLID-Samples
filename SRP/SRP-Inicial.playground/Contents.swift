...
/**
 ...
 Para identificar las responsabilidades recuerda; si el método `getDogs()` es un módulo:
 
 - ¿Cuáles son las funciones actuales de este módulo? ¿Hay más de una función?
